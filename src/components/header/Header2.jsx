              ...
              <div className="col-lg-12">
                <div className="top-bar-items">
                  ...
                  <div className="top-bar-icon">
                    <Link href="/">
                      <a>
                        <span className="fw-bold h3" style={{color: '#111'}}>Your Logo Here</span>
            ...
            <div className="row">
              <div className="col-12 d-flex align-items-center justify-content-between">
                <div className="header-logo">
                  <Link href="/">
                    <a>
                      <span className="fw-bold h4" style={{color: '#111'}}>Your Logo Here</span>
                ...
                >
                  ...
                  <ul className="menu-list">
                    <li>
                      <Link href="/">
                        <a  className={currentRoute === "/" ?"drop-down active":"drop-down"}>Home</a>
                      </Link>
                    </li>
                    <li>
                    ...
                    >
                      <a href="#" className=  "drop-down" >Suites</a>
                      <i
                        className={
