...
function About4() {
  return (
    <div className="home4-about mb-120">
      <div className="container">
        <div className="row g-4 align-items-center">
          <div className="col-lg-6">
            <div className="section-title-4  ">
              <h4>Wellcome Hotelina</h4>
              <h2>We Provide The Best Hotel Facilities.</h2>
            </div>
            <div className="about-left-content  ">
              ...
              <div className="about-img  ">
                <img
                  className="img-fluid"
                  src="assets/images/bg/h4-about-1.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="col-lg-6">
            <div className="about-right">
              <div className="about-img  ">
                <img
                  className="img-fluid"
                  src="assets/images/bg/h4-about-2.png"
                  alt=""
                />
              </div>
              <div className="about-content  ">
                <p>
                  Hotel ut nisl quam nestibulum ac quam nec odio elementum oneni
                  sceisuen the aucan ligula. Orci varius natoque penatibus
                  ethemen habitant forminy morbine.{" "}
                </p>
                <div className="contect-area d-flex align-items-center justify-content-between flex-wrap">
